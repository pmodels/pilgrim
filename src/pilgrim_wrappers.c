...
int MPI_Win_create(void *base, MPI_Aint size, int disp_unit, MPI_Info info, MPI_Comm comm, MPI_Win *win)
{
	...
	MPI_Info obj_0 = info;
	void **args = assemble_args_list(6, addr2id(base), &size, &disp_unit, MPI_OBJ_ID(MPI_Info, &obj_0), &comm, MPI_OBJ_ID(MPI_Win, win));
...
int MPI_Win_get_info(MPI_Win win, MPI_Info *info_used)
{
	...
	int sizes[] = { sizeof(int), 1 * sizeof(MPI_Info) };
	PILGRIM_TRACING_2(2, sizes, args);
}
...
int MPI_Type_create_resized(MPI_Datatype oldtype, MPI_Aint lb, MPI_Aint extent, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), sizeof(MPI_Aint), sizeof(MPI_Aint), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Comm_remote_group(MPI_Comm comm, MPI_Group *group)
{
	...
	void **args = assemble_args_list(2, &comm, MPI_OBJ_ID(MPI_Group, group));
...
int MPI_Mrecv(void *buf, int count, MPI_Datatype datatype, MPI_Message *message, MPI_Status *status)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), 1 * sizeof(MPI_Message), sizeof(int)*2 };
...
int MPI_Group_excl(MPI_Group group, int n, const int ranks[], MPI_Group *newgroup)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), n * sizeof(const int), 1 * sizeof(MPI_Group) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Group_union(MPI_Group group1, MPI_Group group2, MPI_Group *newgroup)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), 1 * sizeof(MPI_Group) };
	PILGRIM_TRACING_2(3, sizes, args);
}
int MPI_Type_get_contents(MPI_Datatype datatype, int max_integers, int max_addresses, int max_datatypes, int array_of_integers[], MPI_Aint array_of_addresses[], MPI_Datatype array_of_datatypes[])
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), max_integers * sizeof(int), max_addresses * sizeof(MPI_Aint), max_datatypes * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Type_create_hindexed_block(int count, int blocklength, const MPI_Aint array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), count * sizeof(const MPI_Aint), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Type_create_indexed_block(int count, int blocklength, const int array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	MPI_Datatype obj_0 = oldtype;
	void **args = assemble_args_list(5, &count, &blocklength, array_of_displacements, MPI_OBJ_ID(MPI_Datatype, &obj_0), MPI_OBJ_ID(MPI_Datatype, newtype));
	int sizes[] = { sizeof(int), sizeof(int), count * sizeof(const int), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
int MPI_Type_create_hindexed(int count, const int array_of_blocklengths[], const MPI_Aint array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), count * sizeof(const int), count * sizeof(const MPI_Aint), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Imrecv(void *buf, int count, MPI_Datatype datatype, MPI_Message *message, MPI_Request *request)
{
	...
	MPI_OBJ_RELEASE(MPI_Message, message);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), 1 * sizeof(MPI_Message), sizeof(int) };
...
int MPI_Win_create_dynamic(MPI_Info info, MPI_Comm comm, MPI_Win *win)
{
	...
	MPI_Info obj_0 = info;
	void **args = assemble_args_list(3, MPI_OBJ_ID(MPI_Info, &obj_0), &comm, MPI_OBJ_ID(MPI_Win, win));
...
int MPI_Rput(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win, MPI_Request *request)
{
	...
	MPI_Datatype obj_1 = target_datatype;
	MPI_Win obj_2 = win;
	void **args = assemble_args_list(9, addr2id(origin_addr), &origin_count, MPI_OBJ_ID(MPI_Datatype, &obj_0), &target_rank, &target_disp, &target_count, MPI_OBJ_ID(MPI_Datatype, &obj_1), MPI_OBJ_ID(MPI_Win, &obj_2), request2id(request, 0, 0));
...
int MPI_Type_indexed(int count, const int array_of_blocklengths[], const int array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	MPI_Datatype obj_0 = oldtype;
	void **args = assemble_args_list(5, &count, array_of_blocklengths, array_of_displacements, MPI_OBJ_ID(MPI_Datatype, &obj_0), MPI_OBJ_ID(MPI_Datatype, newtype));
	int sizes[] = { sizeof(int), count * sizeof(const int), count * sizeof(const int), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Type_create_darray(int size, int rank, int ndims, const int array_of_gsizes[], const int array_of_distribs[], const int array_of_dargs[], const int array_of_psizes[], int order, MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), ndims * sizeof(const int), ndims * sizeof(const int), ndims * sizeof(const int), ndims * sizeof(const int), sizeof(int), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(10, sizes, args);
}
...
int MPI_Type_create_subarray(int ndims, const int array_of_sizes[], const int array_of_subsizes[], const int array_of_starts[], int order, MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), ndims * sizeof(const int), ndims * sizeof(const int), ndims * sizeof(const int), sizeof(int), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Rget_accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, void *result_addr, int result_count, MPI_Datatype result_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
	...
	MPI_Op obj_3 = op;
	MPI_Win obj_4 = win;
	void **args = assemble_args_list(13, addr2id(origin_addr), &origin_count, MPI_OBJ_ID(MPI_Datatype, &obj_0), addr2id(result_addr), &result_count, MPI_OBJ_ID(MPI_Datatype, &obj_1), &target_rank, &target_disp, &target_count, MPI_OBJ_ID(MPI_Datatype, &obj_2), MPI_OBJ_ID(MPI_Op, &obj_3), MPI_OBJ_ID(MPI_Win, &obj_4), request2id(request, 0, 0));
...
int MPI_Group_range_excl(MPI_Group group, int n, int ranges[][3], MPI_Group *newgroup)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), n*3 * sizeof(int), 1 * sizeof(MPI_Group) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Type_create_hvector(int count, int blocklength, MPI_Aint stride, MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(MPI_Aint), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Comm_create_group(MPI_Comm comm, MPI_Group group, int tag, MPI_Comm *newcomm)
{
	...
	MPI_Group obj_0 = group;
	void **args = assemble_args_list(4, &comm, MPI_OBJ_ID(MPI_Group, &obj_0), &tag, newcomm);
	int sizes[] = { sizeof(MPI_Comm), sizeof(int), sizeof(int), 1 * sizeof(MPI_Comm) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Ialltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const int rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request)
{
	...
	int sizes[] = { sizeof(int), 1 * sizeof(const int), 1 * sizeof(const int), 1 * sizeof(const MPI_Datatype), sizeof(int), 1 * sizeof(const int), 1 * sizeof(const int), 1 * sizeof(const MPI_Datatype), sizeof(MPI_Comm), sizeof(int) };
	PILGRIM_TRACING_2(10, sizes, args);
}
...
int MPI_Mprobe(int source, int tag, MPI_Comm comm, MPI_Message *message, MPI_Status *status)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(MPI_Comm), 1 * sizeof(MPI_Message), sizeof(int)*2 };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Type_vector(int count, int blocklength, int stride, MPI_Datatype oldtype, MPI_Datatype *newtype)
{
	...
	MPI_Datatype obj_0 = oldtype;
	void **args = assemble_args_list(5, &count, &blocklength, &stride, MPI_OBJ_ID(MPI_Datatype, &obj_0), MPI_OBJ_ID(MPI_Datatype, newtype));
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1 * sizeof(MPI_Datatype) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Win_allocate(MPI_Aint size, int disp_unit, MPI_Info info, MPI_Comm comm, void *baseptr, MPI_Win *win)
{
	...
	MPI_Info obj_0 = info;
	void **args = assemble_args_list(6, &size, &disp_unit, MPI_OBJ_ID(MPI_Info, &obj_0), &comm, addr2id(baseptr), MPI_OBJ_ID(MPI_Win, win));
...
int MPI_File_open(MPI_Comm comm, const char *filename, int amode, MPI_Info info, MPI_File *fh)
{
	...
	int sizes[] = { sizeof(MPI_Comm), strlen(filename)+1, sizeof(int), sizeof(int), 1 * sizeof(MPI_File) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Comm_create(MPI_Comm comm, MPI_Group group, MPI_Comm *newcomm)
{
	...
	MPI_Group obj_0 = group;
	void **args = assemble_args_list(3, &comm, MPI_OBJ_ID(MPI_Group, &obj_0), newcomm);
	int sizes[] = { sizeof(MPI_Comm), sizeof(int), 1 * sizeof(MPI_Comm) };
	PILGRIM_TRACING_2(3, sizes, args);
}
...
int MPI_Raccumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
	...
	MPI_Op obj_2 = op;
	MPI_Win obj_3 = win;
	void **args = assemble_args_list(10, addr2id(origin_addr), &origin_count, MPI_OBJ_ID(MPI_Datatype, &obj_0), &target_rank, &target_disp, &target_count, MPI_OBJ_ID(MPI_Datatype, &obj_1), MPI_OBJ_ID(MPI_Op, &obj_2), MPI_OBJ_ID(MPI_Win, &obj_3), request2id(request, 0, 0));
...
int MPI_File_get_view(MPI_File fh, MPI_Offset *disp, MPI_Datatype *etype, MPI_Datatype *filetype, char *datarep)
{
	...
	int sizes[] = { sizeof(int), 1 * sizeof(MPI_Offset), 1 * sizeof(MPI_Datatype), 1 * sizeof(MPI_Datatype), strlen(datarep)+1 };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Improbe(int source, int tag, MPI_Comm comm, int *flag, MPI_Message *message, MPI_Status *status)
{
	...
	int sizes[] = { sizeof(int), sizeof(int), sizeof(MPI_Comm), 1 * sizeof(int), 1 * sizeof(MPI_Message), sizeof(int)*2 };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Ineighbor_alltoallw(const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const MPI_Aint rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request)
{
	...
	void **args = assemble_args_list(10, addr2id(sendbuf), sendcounts, sdispls, MPI_OBJ_ID(MPI_Datatype, sendtypes), addr2id(recvbuf), recvcounts, rdispls, MPI_OBJ_ID(MPI_Datatype, recvtypes), &comm, request2id(request, 0, 0));
	int sizes[] = { sizeof(int), 1 * sizeof(const int), 1 * sizeof(const MPI_Aint), 1 * sizeof(const MPI_Datatype), sizeof(int), 1 * sizeof(const int), 1 * sizeof(const MPI_Aint), 1 * sizeof(const MPI_Datatype), sizeof(MPI_Comm), sizeof(int) };
	PILGRIM_TRACING_2(10, sizes, args);
}
