...
int main(int argc, char **argv)
{
    ...
    /* src/mpi/romio/adio/common/ad_fcntl.c */
    ...
    /* src/mpi/romio/mpi-io/iread_all.c */
    ...
    /* src/mpi/romio/mpi-io/read_ordb.c */
    ...
    /* src/mpi/romio/mpi-io/set_atom.c */
    ...
    char s1[] = "string1";
    int i2 = MPI_INFO_NULL;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpi_lookup_name", "**mpi_lookup_name %s %I", s1, i2 );
    ChkMsg( err, MPI_ERR_OTHER, "**mpi_lookup_name %s %I" );
    }
