...
m4_define([PILGRIM_VERSION_m4],[unreleased])dnl
m4_define([PILGRIM_RELEASE_DATE_m4],[unreleased development copy])dnl
...
m4_define([libpilgrim_so_version_m4],[0:0:0])dnl
