...
int MPI_Sendrecv_replace(void *buf, int count, MPI_Datatype datatype, int dest, int sendtag, int source, int recvtag, MPI_Comm comm, MPI_Status *status)
{
	...
	void **args = assemble_args_list(9, addr2id(buf), &count, &obj_id_0, &dest_rank, &sendtag, &source_rank, &recvtag, &obj_id_1, status_arg);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int)*2 };
...
int MPI_Win_create(void *base, MPI_Aint size, int disp_unit, MPI_Info info, MPI_Comm comm, MPI_Win *win)
{
	...
	void **args = assemble_args_list(6, addr2id(base), &size, &disp_unit, &obj_id_0, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(MPI_Aint), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
...
int MPI_File_write_all_begin(MPI_File fh, const void *buf, int count, MPI_Datatype datatype)
{
	...
	void **args = assemble_args_list(4, &obj_id_0, addr2id(buf), &count, &obj_id_1);
...
int MPI_Iallgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request)
{
	...
	void **args = assemble_args_list(8, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
...
int MPI_Grequest_start(MPI_Grequest_query_function *query_fn, MPI_Grequest_free_function *free_fn, MPI_Grequest_cancel_function *cancel_fn, void *extra_state, MPI_Request *request)
{
	...
	void **args = assemble_args_list(5, query_fn, free_fn, cancel_fn, addr2id(extra_state), &obj_id_0);
...
int MPI_Allgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(7, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &obj_id_2);
...
int MPI_Neighbor_allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(8, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), recvcounts, displs, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(8, sizes, args);
}
...
int MPI_File_read_all_end(MPI_File fh, void *buf, MPI_Status *status)
{
	...
	int obj_id_0 = MPI_OBJ_ID(MPI_File, &obj_0);
	int status_arg[2] = {0};
	void **args = assemble_args_list(3, &obj_id_0, addr2id(buf), status_arg);
...
int MPI_Irsend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	int obj_id_2 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(7, addr2id(buf), &count, &obj_id_0, &dest_rank, &tag, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Igatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(10, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), recvcounts, displs, &obj_id_1, &root, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
...
int MPI_Mrecv(void *buf, int count, MPI_Datatype datatype, MPI_Message *message, MPI_Status *status)
{
	...
	int status_arg[2] = {0};
	void **args = assemble_args_list(5, addr2id(buf), &count, &obj_id_0, &obj_id_1, status_arg);
...
int MPI_Win_attach(MPI_Win win, void *base, MPI_Aint size)
{
	...
	MPI_Win obj_0 = win;
	int obj_id_0 = MPI_OBJ_ID(MPI_Win, &obj_0);
	void **args = assemble_args_list(3, &obj_id_0, addr2id(base), &size);
...
int MPI_File_read_at_all(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype, MPI_Status *status)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Datatype, &obj_1);
	int status_arg[2] = {0};
	void **args = assemble_args_list(5, &obj_id_0, addr2id(buf), &count, &obj_id_1, status_arg);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int)*2 };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Type_set_attr(MPI_Datatype datatype, int type_keyval, void *attribute_val)
{
	...
	MPI_Datatype obj_0 = datatype;
	int obj_id_0 = MPI_OBJ_ID(MPI_Datatype, &obj_0);
	void **args = assemble_args_list(3, &obj_id_0, &type_keyval, addr2id(attribute_val));
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(3, sizes, args);
}
...
int MPI_Alloc_mem(MPI_Aint size, MPI_Info info, void *baseptr)
{
	...
	MPI_Info obj_0 = info;
	int obj_id_0 = MPI_OBJ_ID(MPI_Info, &obj_0);
	void **args = assemble_args_list(3, &size, &obj_id_0, addr2id(baseptr));
...
int MPI_File_iwrite_shared(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Datatype, &obj_1);
	int obj_id_2 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(5, &obj_id_0, addr2id(buf), &count, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Allreduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(6, addr2id(sendbuf), addr2id(recvbuf), &count, &obj_id_0, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Reduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, int root, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(7, addr2id(sendbuf), addr2id(recvbuf), &count, &obj_id_0, &obj_id_1, &root, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Ineighbor_allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(9, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), recvcounts, displs, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
int MPI_Compare_and_swap(const void *origin_addr, const void *compare_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Win win)
{
	...
	MPI_Win obj_1 = win;
	int obj_id_1 = MPI_OBJ_ID(MPI_Win, &obj_1);
	void **args = assemble_args_list(7, addr2id(origin_addr), addr2id(compare_addr), addr2id(result_addr), &obj_id_0, &target_rank, &target_disp, &obj_id_1);
...
int MPI_Type_get_attr(MPI_Datatype datatype, int type_keyval, void *attribute_val, int *flag)
{
	...
	MPI_Datatype obj_0 = datatype;
	int obj_id_0 = MPI_OBJ_ID(MPI_Datatype, &obj_0);
	void **args = assemble_args_list(4, &obj_id_0, &type_keyval, addr2id(attribute_val), flag);
...
int MPI_Attr_get(MPI_Comm comm, int keyval, void *attribute_val, int *flag)
{
	...
	MPI_Comm obj_0 = comm;
	int obj_id_0 = MPI_OBJ_ID(MPI_Comm, &obj_0);
	void **args = assemble_args_list(4, &obj_id_0, &keyval, addr2id(attribute_val), flag);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), 1*sizeof(int) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Imrecv(void *buf, int count, MPI_Datatype datatype, MPI_Message *message, MPI_Request *request)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Message, message);
	int obj_id_2 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(5, addr2id(buf), &count, &obj_id_0, &obj_id_1, &obj_id_2);
	MPI_OBJ_RELEASE(MPI_Message, message);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
...
int MPI_Neighbor_alltoallw(const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const MPI_Aint rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(9, addr2id(sendbuf), sendcounts, sdispls, &obj_id_0, addr2id(recvbuf), recvcounts, rdispls, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), 1*sizeof(const int), 1*sizeof(const MPI_Aint), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const MPI_Aint), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
int MPI_Neighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(9, addr2id(sendbuf), sendcounts, sdispls, &obj_id_0, addr2id(recvbuf), recvcounts, rdispls, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
...
int MPI_Put(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win)
{
	...
	void **args = assemble_args_list(8, addr2id(origin_addr), &origin_count, &obj_id_0, &target_rank, &target_disp, &target_count, &obj_id_1, &obj_id_2);
...
int MPI_Ibcast(void *buffer, int count, MPI_Datatype datatype, int root, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	int obj_id_2 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(6, addr2id(buffer), &count, &obj_id_0, &root, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Rput(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Win, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(9, addr2id(origin_addr), &origin_count, &obj_id_0, &target_rank, &target_disp, &target_count, &obj_id_1, &obj_id_2, &obj_id_3);
...
int MPI_Gather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(8, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &root, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(8, sizes, args);
}
...
int MPI_Rget_accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, void *result_addr, int result_count, MPI_Datatype result_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
	...
	void **args = assemble_args_list(13, addr2id(origin_addr), &origin_count, &obj_id_0, addr2id(result_addr), &result_count, &obj_id_1, &target_rank, &target_disp, &target_count, &obj_id_2, &obj_id_3, &obj_id_4, &obj_id_5);
...
int MPI_Win_get_attr(MPI_Win win, int win_keyval, void *attribute_val, int *flag)
{
	...
	MPI_Win obj_0 = win;
	int obj_id_0 = MPI_OBJ_ID(MPI_Win, &obj_0);
	void **args = assemble_args_list(4, &obj_id_0, &win_keyval, addr2id(attribute_val), flag);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), 1*sizeof(int) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Comm_get_attr(MPI_Comm comm, int comm_keyval, void *attribute_val, int *flag)
{
	...
	MPI_Comm obj_0 = comm;
	int obj_id_0 = MPI_OBJ_ID(MPI_Comm, &obj_0);
	void **args = assemble_args_list(4, &obj_id_0, &comm_keyval, addr2id(attribute_val), flag);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), 1*sizeof(int) };
	PILGRIM_TRACING_2(4, sizes, args);
}
...
int MPI_Get_accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, void *result_addr, int result_count, MPI_Datatype result_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)
{
	...
	MPI_Win obj_4 = win;
	int obj_id_4 = MPI_OBJ_ID(MPI_Win, &obj_4);
	void **args = assemble_args_list(12, addr2id(origin_addr), &origin_count, &obj_id_0, addr2id(result_addr), &result_count, &obj_id_1, &target_rank, &target_disp, &target_count, &obj_id_2, &obj_id_3, &obj_id_4);
...
int MPI_Scatterv(const void *sendbuf, const int sendcounts[], const int displs[], MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(9, addr2id(sendbuf), sendcounts, displs, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &root, &obj_id_2);
	int sizes[] = { sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
...
int MPI_Reduce_local(const void *inbuf, void *inoutbuf, int count, MPI_Datatype datatype, MPI_Op op)
{
	...
	MPI_Op obj_1 = op;
	int obj_id_1 = MPI_OBJ_ID(MPI_Op, &obj_1);
	void **args = assemble_args_list(5, addr2id(inbuf), addr2id(inoutbuf), &count, &obj_id_0, &obj_id_1);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Ireduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(7, addr2id(sendbuf), addr2id(recvbuf), &recvcount, &obj_id_0, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
int MPI_Ialltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const int rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(10, addr2id(sendbuf), sendcounts, sdispls, &obj_id_0, addr2id(recvbuf), recvcounts, rdispls, &obj_id_1, &obj_id_2, &obj_id_3);
...
int MPI_Iallreduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(7, addr2id(sendbuf), addr2id(recvbuf), &count, &obj_id_0, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Fetch_and_op(const void *origin_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Op op, MPI_Win win)
{
	...
	MPI_Win obj_2 = win;
	int obj_id_2 = MPI_OBJ_ID(MPI_Win, &obj_2);
	void **args = assemble_args_list(7, addr2id(origin_addr), addr2id(result_addr), &obj_id_0, &target_rank, &target_disp, &obj_id_1, &obj_id_2);
...
int MPI_Reduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(6, addr2id(sendbuf), addr2id(recvbuf), &recvcount, &obj_id_0, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Win_set_attr(MPI_Win win, int win_keyval, void *attribute_val)
{
	...
	MPI_Win obj_0 = win;
	int obj_id_0 = MPI_OBJ_ID(MPI_Win, &obj_0);
	void **args = assemble_args_list(3, &obj_id_0, &win_keyval, addr2id(attribute_val));
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(3, sizes, args);
}
...
int MPI_Iscatterv(const void *sendbuf, const int sendcounts[], const int displs[], MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(10, addr2id(sendbuf), sendcounts, displs, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &root, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(10, sizes, args);
}
...
int MPI_Attr_put(MPI_Comm comm, int keyval, void *attribute_val)
{
	...
	MPI_Comm obj_0 = comm;
	int obj_id_0 = MPI_OBJ_ID(MPI_Comm, &obj_0);
	void **args = assemble_args_list(3, &obj_id_0, &keyval, addr2id(attribute_val));
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(3, sizes, args);
}
int MPI_Iscatter(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(9, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), &recvcount, &obj_id_1, &root, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
...
int MPI_Win_allocate(MPI_Aint size, int disp_unit, MPI_Info info, MPI_Comm comm, void *baseptr, MPI_Win *win)
{
	...
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	int obj_id_2 = MPI_OBJ_ID(MPI_Win, win);
	void **args = assemble_args_list(6, &size, &disp_unit, &obj_id_0, &obj_id_1, addr2id(baseptr), &obj_id_2);
	int sizes[] = { sizeof(MPI_Aint), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Recv(void *buf, int count, MPI_Datatype datatype, int source, int tag, MPI_Comm comm, MPI_Status *status)
{
	...
	if(source == MPI_ANY_SOURCE && status && status!=MPI_STATUS_IGNORE) status_arg[0] = status->MPI_SOURCE;
	if(tag == MPI_ANY_TAG && status && status!=MPI_STATUS_IGNORE) status_arg[1] = status->MPI_TAG;
	void **args = assemble_args_list(7, addr2id(buf), &count, &obj_id_0, &source_rank, &tag, &obj_id_1, status_arg);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int)*2 };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Ireduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[], MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(7, addr2id(sendbuf), addr2id(recvbuf), recvcounts, &obj_id_0, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Pack(const void *inbuf, int incount, MPI_Datatype datatype, void *outbuf, int outsize, int *position, MPI_Comm comm)
{
	...
	MPI_Comm obj_1 = comm;
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	void **args = assemble_args_list(7, addr2id(inbuf), &incount, &obj_id_0, addr2id(outbuf), &outsize, position, &obj_id_1);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1*sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Gatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, int root, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(9, addr2id(sendbuf), &sendcount, &obj_id_0, addr2id(recvbuf), recvcounts, displs, &obj_id_1, &root, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(9, sizes, args);
}
...
int MPI_Reduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[], MPI_Datatype datatype, MPI_Op op, MPI_Comm comm)
{
	...
	MPI_Comm obj_2 = comm;
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	void **args = assemble_args_list(6, addr2id(sendbuf), addr2id(recvbuf), recvcounts, &obj_id_0, &obj_id_1, &obj_id_2);
	int sizes[] = { sizeof(int), sizeof(int), 1*sizeof(const int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(6, sizes, args);
}
...
int MPI_Pack_external(const char datarep[], const void *inbuf, int incount, MPI_Datatype datatype, void *outbuf, MPI_Aint outsize, MPI_Aint *position)
{
	...
	MPI_Datatype obj_0 = datatype;
	int obj_id_0 = MPI_OBJ_ID(MPI_Datatype, &obj_0);
	void **args = assemble_args_list(7, datarep, addr2id(inbuf), &incount, &obj_id_0, addr2id(outbuf), &outsize, position);
...
int MPI_Sendrecv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, int dest, int sendtag, void *recvbuf, int recvcount, MPI_Datatype recvtype, int source, int recvtag, MPI_Comm comm, MPI_Status *status)
{
	...
	if(source == MPI_ANY_SOURCE && status && status!=MPI_STATUS_IGNORE) status_arg[0] = status->MPI_SOURCE;
	if(recvtag == MPI_ANY_TAG && status && status!=MPI_STATUS_IGNORE) status_arg[1] = status->MPI_TAG;
	void **args = assemble_args_list(12, addr2id(sendbuf), &sendcount, &obj_id_0, &dest_rank, &sendtag, addr2id(recvbuf), &recvcount, &obj_id_1, &source_rank, &recvtag, &obj_id_2, status_arg);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int)*2 };
	PILGRIM_TRACING_2(12, sizes, args);
}
int MPI_Win_shared_query(MPI_Win win, int rank, MPI_Aint *size, int *disp_unit, void *baseptr)
{
	...
	MPI_Win obj_0 = win;
	int obj_id_0 = MPI_OBJ_ID(MPI_Win, &obj_0);
	void **args = assemble_args_list(5, &obj_id_0, &rank, size, disp_unit, addr2id(baseptr));
...
int MPI_Comm_set_attr(MPI_Comm comm, int comm_keyval, void *attribute_val)
{
	...
	MPI_Comm obj_0 = comm;
	int obj_id_0 = MPI_OBJ_ID(MPI_Comm, &obj_0);
	void **args = assemble_args_list(3, &obj_id_0, &comm_keyval, addr2id(attribute_val));
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(3, sizes, args);
}
...
int MPI_Bcast(void *buffer, int count, MPI_Datatype datatype, int root, MPI_Comm comm)
{
	...
	MPI_Comm obj_1 = comm;
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	void **args = assemble_args_list(5, addr2id(buffer), &count, &obj_id_0, &root, &obj_id_1);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(5, sizes, args);
}
...
int MPI_Raccumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
	...
	void **args = assemble_args_list(10, addr2id(origin_addr), &origin_count, &obj_id_0, &target_rank, &target_disp, &target_count, &obj_id_1, &obj_id_2, &obj_id_3, &obj_id_4);
...
int MPI_Unpack(const void *inbuf, int insize, int *position, void *outbuf, int outcount, MPI_Datatype datatype, MPI_Comm comm)
{
	...
	MPI_Comm obj_1 = comm;
	int obj_id_1 = MPI_OBJ_ID(MPI_Comm, &obj_1);
	void **args = assemble_args_list(7, addr2id(inbuf), &insize, position, addr2id(outbuf), &outcount, &obj_id_0, &obj_id_1);
	int sizes[] = { sizeof(int), sizeof(int), 1*sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(7, sizes, args);
}
...
int MPI_Unpack_external(const char datarep[], const void *inbuf, MPI_Aint insize, MPI_Aint *position, void *outbuf, int outcount, MPI_Datatype datatype)
{
	...
	MPI_Datatype obj_0 = datatype;
	int obj_id_0 = MPI_OBJ_ID(MPI_Datatype, &obj_0);
	void **args = assemble_args_list(7, datarep, addr2id(inbuf), &insize, position, addr2id(outbuf), &outcount, &obj_id_0);
...
int MPI_Win_detach(MPI_Win win, const void *base)
{
	...
	MPI_Win obj_0 = win;
	int obj_id_0 = MPI_OBJ_ID(MPI_Win, &obj_0);
	void **args = assemble_args_list(2, &obj_id_0, addr2id(base));
	int sizes[] = { sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(2, sizes, args);
}
...
int MPI_Ineighbor_alltoallw(const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const MPI_Aint rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(10, addr2id(sendbuf), sendcounts, sdispls, &obj_id_0, addr2id(recvbuf), recvcounts, rdispls, &obj_id_1, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), 1*sizeof(const int), 1*sizeof(const MPI_Aint), sizeof(int), sizeof(int), 1*sizeof(const int), 1*sizeof(const MPI_Aint), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(10, sizes, args);
}
...
int MPI_Ireduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, int root, MPI_Comm comm, MPI_Request *request)
{
	...
	int obj_id_2 = MPI_OBJ_ID(MPI_Comm, &obj_2);
	int obj_id_3 = MPI_OBJ_ID(MPI_Request, request);
	void **args = assemble_args_list(8, addr2id(sendbuf), addr2id(recvbuf), &count, &obj_id_0, &obj_id_1, &root, &obj_id_2, &obj_id_3);
	int sizes[] = { sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int), sizeof(int) };
	PILGRIM_TRACING_2(8, sizes, args);
}
